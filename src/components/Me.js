  ...
  <header className="anim-masthead" id="home">
    <div className="container d-flex h-100 align-items-center">
      <div className="mx-auto">
        <div className="row text-center align-items-center pb-2 d-none d-sm-flex">
          <div className="col-12">
            <Link to='/skills'>
              <button className="btn glow-on-hover btn-med mx-2 my-2 fadein fadein-third">Skills</button>
            </Link>
            <Link to='/projects'>
              <button className="btn glow-on-hover btn-med mx-2 my-2 fadein fadein-third">Portfolio</button>
            </Link>
            <Link to='/tweets'>
              <button className="btn glow-on-hover btn-med mx-2 my-2 fadein fadein-third">Tweets</button>
            </Link>
            <a href="https://docs.google.com/document/d/1wDLnDSzeLd2c6ecFKbzIU7bDV_pzq7mbRcmEACvWQLY/edit?usp=sharing" target="_blank" rel="noopener noreferrer">
              <button className="btn glow-on-hover btn-med mx-2 my-2 fadein fadein-third">Resume</button>
            </a>
          </div>
        </div>
        <div className="row text-center align-items-center">
          <div className="col-12 col-md-6 order-12 order-md-1 mx-auto">
